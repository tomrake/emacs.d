...
Entering of new tasks is by Remember mode.
...
*** Ensure there are standard user ~/org directories
 ...
 Under windows and linux this is ~/org.
  ...
  (unless (file-directory-p org-public-dir)
    (make-directory org-public-dir))  
  #+END_SRC
 ...
 #+BEGIN_SRC emacs-lisp
	 ...
	 ("ht" "Temperature (t)" table-line (file+headline ,(concat org-public-dir "/notes/Medical-Data.org") "Temperature")
      ...
      ;; Small Items
         ("i" "Small Items")
      ;; Shoppping Items
	 ("is" "Shopping Request (s)" table-line (file+headline ,(concat org-public-dir "/notes/Shopping-Requests.org") "Requests")
	  "|%U|%^{Needed Item}|")
      ;; Shoppping Items
	 ("ie" "Fetch from Extension at Southfork Requests (e)" table-line
   (file+headline ,(concat org-public-dir "/notes/Fetching-Requests.org") "Fetch Requests") "|%U|%^{Needed Item}|")
      ;; Items for James O. Seese
         ("ij" "Item for James O Seese (j)" table-line
   (file+headline ,(concat org-user-dir "/agenda/JOS-POA.org") "Review Items") "|%U|%^{Needed Item}|")
      ;; List of Goals
	 ("g" "Set a goal (g)")
