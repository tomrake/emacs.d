...
* HACKING - READ AND REMOVE WHEN DONE
  I am planning on removing old SBCL SLIME cruff the sections will be marked with [CRUFF]
* README
...
[TBD] This entire piece should be removed? or moved to Provisioning.
#+BEGIN_SRC emacs-lisp
...
* Copy OS PATH to emacs path [CRUFF]
This seems unused.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Binary from SBCL 2.0.0 MSYS unknown. [CRUFF]
...
*** Binary from 2.0.2 MSYS64 Unknown. [CRUFF]
 This is assumed to be broken.
 #+BEGIN_SRC emacs-lisp :tangle no
