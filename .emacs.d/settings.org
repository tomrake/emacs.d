...
I want to backup things in [[~/]] by FileHistory that material is in [[~/Documents/Code]]

Most of the items in that directory are symlinked to ~/ (really MKLINK).
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun invoke-standard-sbcl (tag program environment)
    (add-slime-lisp tag program '("--noinform" "-i") environment))
#+END_SRC
...
** Provision a ABCL entry for slime
  ...
  (defun provision-abcl()
    (let ((java "C:/Program Files/Java/jre1.8.0_333/bin/java.exe")
          (abcl "C:/Program Files/ABCL/abcl.jar"))
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   ;	      :config
	    ...
	    ;;;; Remove any empty items
		 ...
		 (if nil
		     (progn
		       (setenv "SBCL_HOME" (msys-path "usr/local/sbcl-2.2.6/lib/sbcl/"))
		       (setf inferior-lisp-program (msys-path "usr/local/sbcl-2.2.6/bin/sbcl.exe")))
		     (progn
		   (setq slime-lisp-implementations
		     (seq-filter (lambda (e) e)
		       (list
      ;		  '(sbcl ("C:/devel/msys65/bin/bash" "-c" "C:/devel/msys64/usr/local/bin/sbcl" "--noinform"))
			(msys-sbcl 'msys-sbcl-2.2.6 "usr/local/sbcl-2.2.6/")
			(msys-sbcl 'msys-sbcl-2.2.5 "usr/local/sbcl-2.2.5/")
...
* Org link abbreviations
 ...
 #+RESULTS:
 : ((bugzilla . http://192.168.1.50/bugzilla/show_bug.cgi?id=) (bugzilla-comp . http://192.168.1.50/bugzilla/describecomponents.cgi?product=) (common-docs . file:///C:/Users/zzzap/Documents/Common-Document-Store/%s))
