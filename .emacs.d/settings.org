	 ...
	 (use-package slime
      ...
      ;;;; Remove any empty items
		 ...
		 (list
		  ...
		  '(sbcl-5  ("C:/devel/msys64/usr/local/sbcl-2.2.5/bin/sbcl.exe"  "--noinform")
			    :env ("SBCL_HOME=C:/devel/msys64/usr/local/sbcl-2.2.5/lib/sbcl/"))
		  (sbcl-2-2-5)
		  '(sbcl-6  ("C:/devel/msys64/usr/local/sbcl-2.2.6/bin/sbcl.exe"  "--noinform")
			    :env ("SBCL_HOME=C:/devel/msys64/usr/local/sbcl-2.2.6/lib/sbcl/"))
		  (sbcl-2-2-6)
		  (provision-ccl)
		  ;(sbcl-2-2-6)
...
#+BEGIN_SRC emacs-lisp
  ...
  (setenv "PATH" (concat (getenv "PATH") (concat ";" +msys64-base-path+ "usr/bin/")))
#+END_SRC
