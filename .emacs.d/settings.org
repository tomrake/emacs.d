   ...
   ;;      (require 'slime-auto-loads)
	 (use-package slime
      ...
      ;;;; Remove any empty items
		 ...
		 (list
	       	  `(sbcl-5  ,(cons "C:/devel/msys64/usr/local/sbcl-2.2.5/bin/sbcl.exe"  (standard-sbcl-options)))
	          (sbcl-2-2-5)
		  `(sbcl-6 ,(cons "C:/devel/msys64/usr/local/sbcl-2.2.6/bin/sbcl.exe"  (standard-sbcl-options)))
		  (sbcl-2-2-6)
		  (provision-ccl)
		  ;(sbcl-2-2-6)
