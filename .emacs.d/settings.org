...
#+BEGIN_SRC emacs-lisp
  ...
  (defun sbcl-2-2-1-msys ()
    (msys2-slime-implementation-p 'sbcl-2_2_1 "/usr/local/sbcl-2.2.1/bin/sbcl.exe"
		...
		(defun sbcl-2-0-0 ()
		  (only-sbcl-p 'sbcl-2_0_0-only "C:/devel/msys64/usr/local/sbcl-2.0.0/bin/sbcl.exe"
						(list (concat "HOME=" (getenv "HOME")) "SBCL_HOME=C:/devel/msys64/usr/local/sbcl-2.0.0/lib/sbcl")))

		(defun sbcl-2-2-1()
		  (only-sbcl-p 'sbcl-2_2_1-only "C:/devel/msys64/usr/local/sbcl-2.2.1/bin/sbcl.exe"
							    (list (concat "HOME=" (getenv "HOME")) "SBCL_HOME=C:/devel/msys64/usr/local/sbcl-2.2.1/lib/sbcl")))
