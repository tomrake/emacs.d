...
** Capture Templates
 ...
 (setq org-capture-templates
       `(("t" "todo" entry (file ,(concat org-public-agenda-dir "gtd.org"))
 ...
 ;; ("m" "Meeting" entry (file  ,(concat org-public-agenda-dir "gtd.org"))
 ;;  "* MEETING with %^{Meeting with:} %?" :clock-in t :clock-resume t)

 ;; Shoppping Items
    ("s" "Shopping List - Needed (s)" entry (file ,(concat org-public-agenda-dir "gtd.org"))
   ...
   :END:
 ")
	 ("i" "Idea" entry (file ,(concat org-public-agenda-dir "gtd.org"))
	  "* %? :IDEA: \n%t" :clock-in t :clock-resume t)
	 ("j" "Journal" entry (file+datetree ,(concat org-user-dir "diary.org"))
	  "* %U %^{Title}\n  -%?" :clock-in t :clock-resume t)
	 ("n" "Next Task" entry (file+headline  ,(concat org-public-agenda-dir "tasks"))
	  "** NEXT %? \nDEADLINE: %t")))
 #+END_SRC
