...
- My current emacs config is the msys2 version.
  ...
  - miktex
    - Added path addtion to /etc/profile.d/miktex.sh
  - magit
  ...
  - Auto-tangle
    - Has problem with msys launch - this is likely because of the symlink
***  Achieveable Task
...
- The current solution is to execute a program called "java"
- This is a cross platform solution.
- miktex is now added to the PATH by /etc/profile.d/miktex.sh
*** Revision Log
...
**** August 23, 2023
- Solved the modus-theme status line probem
- The auto tangle code is STILL a problem
*** Revision Tagging
