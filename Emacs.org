...
Add a warning to the begining of init.el
...
[[https://github.com/plexus/chemacs2][Chemacs2]] allows seprate emacs.d directores to exists which are boot main ~/.emacs.d directory.
